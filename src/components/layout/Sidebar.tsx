...
import {
  ...
  HandCoins, Undo2, Upload, UserCog, ClipboardEdit, Lock, Truck, PanelLeftOpen, PanelLeftClose
} from 'lucide-react';
...
const ICONS: Record<string, any> = {
  ...
  ajustes_inventario: ClipboardEdit, corte_caja: Lock, corte_caja_ruta: Truck,
