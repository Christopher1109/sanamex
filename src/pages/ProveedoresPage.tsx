              ...
              <TabsContent value="contacto" className="space-y-6 pt-4">
                ...
                <section>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <Field label="Días de entrega (lead time)" type="number" value={(form as any).dias_entrega} onChange={(v: any) => setForm({ ...form, ...( { dias_entrega: v } as any) })} />
                    <Field label="Frecuencia de listas de precio" value={(form as any).frecuencia_listas} onChange={(v: string) => setForm({ ...form, ...( { frecuencia_listas: v } as any) })} />
                  </div>
